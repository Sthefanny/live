...
class NuContaContainer extends StatelessWidget {
                      ...
                      Row(
                        children: <Widget>[
                          Padding(
                            ...
                            child: Icon(Icons.attach_money, color: Colors.grey[700], size: 30),
                          ),
                          Text('NuConta', style: TextStyle(color: Colors.grey[600])),
                        ],
                      ),
